...
load_feature_net = False #True
load_classify_net = False #True
...
# Models
feature_net = models.resnet152(pretrained=True) .type(dtype)
classify_net = ClassifierNet().type(dtype)
gen_net = models.resnet152(pretrained=True).type(dtype) 
